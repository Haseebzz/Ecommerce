...
export default function Checkout() {
  ...
  return (
    <>
        <MainLayout>
            <div id="CheckoutPage" className="w-full mt-4 max-w-[1100px] mx-auto">

                <div className="text-2xl font-bold mt-4 mb-4">Checkout</div>
    
                <div className="flex flex-col md:flex-row  gap-4 justify-between mx-auto w-full">
                    ...
                    <div id="PlaceOrder" className=" -top-[6px] w-full md:w-[50%] border rounded-lg">
                        <ClientOnly>
                            <div className="p-4">
